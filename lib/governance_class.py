...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to soyuzd "gobject list" output
    ...
    def soyuzd_serialise(self):
        import soyuzlib
        return soyuzlib.SHIM_serialise_for_soyuzd(self.serialise())
