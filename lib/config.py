...
sentinel_cfg = SoyuzConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_soyuzd_proto_version_with_sentinel_ping = 70207


def get_soyuz_conf():
    home = os.environ.get('HOME')

    soyuz_conf = os.path.join(home, ".soyuzcore/soyuz.conf")
    if sys.platform == 'darwin':
        soyuz_conf = os.path.join(home, "Library/Application Support/SoyuzCore/soyuz.conf")

    soyuz_conf = sentinel_cfg.get('soyuz_conf', soyuz_conf)
